...
<div id="content">
    ...
    <div class="sector">
        <div class="sector_title"><h4><span class="no">Sec02. </span>에코</h4></div>
        <div class="sector_content">
            <a class="button" href="echoClient">에코 클라이언트</a>
        </div>
        <div id="sec01_result" class="sector_result"></div>
    </div>

    <div class="sector">
        <div class="sector_title"><h4><span class="no">Sec03. </span>채팅</h4></div>
        <div class="sector_content">
            <a class="button" href="chatClient">채팅 클라이언트</a>
        </div>
        <div id="sec01_result" class="sector_result"></div>
    </div>
</div>
